...
export declare class CurrencyMaskDirective implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit, Validator {
    ...
    static ɵfac: i0.ɵɵFactoryDef<CurrencyMaskDirective, [{ optional: true; }, null, null]>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<CurrencyMaskDirective, "[currencyMask]", never, { "max": "max"; "min": "min"; "options": "options"; }, {}, never>;
}
